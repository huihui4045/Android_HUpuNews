...
public class PostActivity extends BaseSwipeBackActivity implements PostContract.View {
  ...
  @Inject PostPresenter mPresenter;
  ...
  @Override public void renderError(BaseError error) {
    if (error != null) {
  ...
  @Override public void renderExam(final Exam exam) {
    if (exam != null) {
      new MaterialDialog.Builder(this).title("温馨提示")
          .content(exam.title)
          .cancelable(false)
  ...
  @Override public void postSuccess() {
